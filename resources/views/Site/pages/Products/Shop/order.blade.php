...
$email = "baylar95@gmail.com";
#
## Tahsil edilecek tutar.
$payment_amount	= "3000"; //9.99 için 9.99 * 100 = 999 gönderilmelidir.
#
## Sipariş numarası: Her işlemde benzersiz olmalıdır!! Bu bilgi bildirim sayfanıza yapılacak bildirimde geri gönderilir.
$merchant_oid  = md5(rand(0,99999)) ;
#
...
$merchant_fail_url =  route('ordercallback') ;
#
## Müşterinin sepet/sipariş içeriği
$user_basket =  base64_encode(json_encode(['"Örnek ürün 1", "18.00", 1']));
#
